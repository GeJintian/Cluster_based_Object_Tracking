    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[
                ...
                {'left_bound_file': "/home/knz/workspace/automan-a2rl/src/detection/LeftBoundXY0425.csv"},
                {'right_bound_file': "/home/knz/workspace/automan-a2rl/src/detection/RightBoundXY0425.csv"},
                #/home/oscar/workspace/a2rl
                #/home/knz/workspace
                {'visualize': False},
                {'non_ground_pub': True},
                {'objects_cloud_pub':True},
                {'core_num':8},
                {'xy_leaf_size': 0.33},
                {'z_leaf_size':0.05},
